window.LESSONS["06:bai-kinh-dien-de-luyen:google-drive-he-thong-luu-file"] = {

"tom_tat": [
  "“Google Drive / hệ thống lưu file” phải được hiểu như một cơ chế có input, state, output và failure mode; không phải định nghĩa để học thuộc.",
  "Áp dụng quy trình requirements→estimate→API/data→high-level→bottleneck→failure.",
  "Kết luận chỉ đáng tin khi có baseline, phép đo/kiểm thử và điều kiện áp dụng được ghi rõ."
],

"can_biet_truoc": [
  "Mô hình nền của module “Bài kinh điển để luyện”.",
...
"dinh_nghia": "**Google Drive / hệ thống lưu file** thuộc System Design, module **Bài kinh điển để luyện**. Hãy định nghĩa nó bằng ba lớp: contract quan sát được từ bên ngoài; state/invariant phải giữ bên trong; và giả định môi trường để guarantee còn đúng. Nếu bỏ lớp giả định, câu “luôn nhanh”, “luôn nhất quán” hay “mô hình tốt” thường trở thành sai.",
...
"tu_kiem_tra": [
  "Vẽ lại luồng của “Google Drive / hệ thống lưu file” và ghi state tại từng node.",
...
"tai_nguyen": [
  ...
  "Roadmap nội bộ: System Design / Bài kinh điển để luyện"
],

"lien_he": "“Google Drive / hệ thống lưu file” nối sang các mảng khác qua cùng ba câu hỏi: dữ liệu/state nằm đâu, contract nào phải giữ, và failure được quan sát/phục hồi thế nào. Khi hệ thống có model AI, quyết định ở bài này ảnh hưởng trực tiếp data quality, serving latency, privacy và khả năng tái lập."
};
