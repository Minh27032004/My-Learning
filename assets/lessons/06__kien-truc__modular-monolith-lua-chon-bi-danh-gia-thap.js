window.LESSONS["06:kien-truc:modular-monolith-lua-chon-bi-danh-gia-thap"] = {

"tom_tat": [
  "“Modular monolith (lựa chọn bị đánh giá thấp)” phải được hiểu như một cơ chế có input, state, output và failure mode; không phải định nghĩa để học thuộc.",
...
"dinh_nghia": "**Modular monolith (lựa chọn bị đánh giá thấp)** thuộc System Design, module **Kiến trúc**. Hãy định nghĩa nó bằng ba lớp: contract quan sát được từ bên ngoài; state/invariant phải giữ bên trong; và giả định môi trường để guarantee còn đúng. Nếu bỏ lớp giả định, câu “luôn nhanh”, “luôn nhất quán” hay “mô hình tốt” thường trở thành sai.",
...
"tu_kiem_tra": [
  "Vẽ lại luồng của “Modular monolith (lựa chọn bị đánh giá thấp)” và ghi state tại từng node.",
