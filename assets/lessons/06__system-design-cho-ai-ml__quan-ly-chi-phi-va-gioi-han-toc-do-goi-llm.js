window.LESSONS["06:system-design-cho-ai-ml:quan-ly-chi-phi-va-gioi-han-toc-do-goi-llm"] = {

"tom_tat": [
  "“Quản lý chi phí và giới hạn tốc độ gọi LLM” phải được hiểu như một cơ chế có input, state, output và failure mode; không phải định nghĩa để học thuộc.",
...
"tu_kiem_tra": [
  "Vẽ lại luồng của “Quản lý chi phí và giới hạn tốc độ gọi LLM” và ghi state tại từng node.",
