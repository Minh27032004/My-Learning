window.LESSONS["06:system-design-cho-ai-ml:pipeline-huan-luyen-lai-va-phat-hien-drift"] = {

"tom_tat": [
  "“Pipeline huấn luyện lại và phát hiện drift” phải được hiểu như một cơ chế có input, state, output và failure mode; không phải định nghĩa để học thuộc.",
...
"tu_kiem_tra": [
  "Vẽ lại luồng của “Pipeline huấn luyện lại và phát hiện drift” và ghi state tại từng node.",
