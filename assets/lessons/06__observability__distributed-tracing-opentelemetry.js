window.LESSONS["06:observability:distributed-tracing-opentelemetry"] = {

"tom_tat": [
  "“Distributed tracing (OpenTelemetry)” phải được hiểu như một cơ chế có input, state, output và failure mode; không phải định nghĩa để học thuộc.",
  "Metrics cho xu hướng, logs cho sự kiện, traces cho causal path; nối tất cả bằng context.",
  "Kết luận chỉ đáng tin khi có baseline, phép đo/kiểm thử và điều kiện áp dụng được ghi rõ."
],

"can_biet_truoc": [
  "Mô hình nền của module “Observability”.",
...
"dinh_nghia": "**Distributed tracing (OpenTelemetry)** thuộc System Design, module **Observability**. Hãy định nghĩa nó bằng ba lớp: contract quan sát được từ bên ngoài; state/invariant phải giữ bên trong; và giả định môi trường để guarantee còn đúng. Nếu bỏ lớp giả định, câu “luôn nhanh”, “luôn nhất quán” hay “mô hình tốt” thường trở thành sai.",
...
"tu_kiem_tra": [
  "Vẽ lại luồng của “Distributed tracing (OpenTelemetry)” và ghi state tại từng node.",
...
"tai_nguyen": [
  ...
  "Roadmap nội bộ: System Design / Observability"
],

"lien_he": "“Distributed tracing (OpenTelemetry)” nối sang các mảng khác qua cùng ba câu hỏi: dữ liệu/state nằm đâu, contract nào phải giữ, và failure được quan sát/phục hồi thế nào. Khi hệ thống có model AI, quyết định ở bài này ảnh hưởng trực tiếp data quality, serving latency, privacy và khả năng tái lập."
};
