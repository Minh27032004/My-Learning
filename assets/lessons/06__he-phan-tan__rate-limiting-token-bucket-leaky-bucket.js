window.LESSONS["06:he-phan-tan:rate-limiting-token-bucket-leaky-bucket"] = {

"tom_tat": [
  "“Rate limiting: token bucket, leaky bucket” phải được hiểu như một cơ chế có input, state, output và failure mode; không phải định nghĩa để học thuộc.",
  "Giả định mạng có thể chậm/mất/lặp; thiết kế idempotency và quorum từ failure model.",
  "Kết luận chỉ đáng tin khi có baseline, phép đo/kiểm thử và điều kiện áp dụng được ghi rõ."
],

"can_biet_truoc": [
  "Mô hình nền của module “Hệ phân tán”.",
...
"dinh_nghia": "**Rate limiting: token bucket, leaky bucket** thuộc System Design, module **Hệ phân tán**. Hãy định nghĩa nó bằng ba lớp: contract quan sát được từ bên ngoài; state/invariant phải giữ bên trong; và giả định môi trường để guarantee còn đúng. Nếu bỏ lớp giả định, câu “luôn nhanh”, “luôn nhất quán” hay “mô hình tốt” thường trở thành sai.",
...
"tu_kiem_tra": [
  "Vẽ lại luồng của “Rate limiting: token bucket, leaky bucket” và ghi state tại từng node.",
...
"tai_nguyen": [
  ...
  "Roadmap nội bộ: System Design / Hệ phân tán"
],

"lien_he": "“Rate limiting: token bucket, leaky bucket” nối sang các mảng khác qua cùng ba câu hỏi: dữ liệu/state nằm đâu, contract nào phải giữ, và failure được quan sát/phục hồi thế nào. Khi hệ thống có model AI, quyết định ở bài này ảnh hưởng trực tiếp data quality, serving latency, privacy và khả năng tái lập."
};
