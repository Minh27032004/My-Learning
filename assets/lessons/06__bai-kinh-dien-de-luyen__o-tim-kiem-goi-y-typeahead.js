window.LESSONS["06:bai-kinh-dien-de-luyen:o-tim-kiem-goi-y-typeahead"] = {

"tom_tat": [
  "“Ô tìm kiếm gợi ý (typeahead)” phải được hiểu như một cơ chế có input, state, output và failure mode; không phải định nghĩa để học thuộc.",
...
"dinh_nghia": "**Ô tìm kiếm gợi ý (typeahead)** thuộc System Design, module **Bài kinh điển để luyện**. Hãy định nghĩa nó bằng ba lớp: contract quan sát được từ bên ngoài; state/invariant phải giữ bên trong; và giả định môi trường để guarantee còn đúng. Nếu bỏ lớp giả định, câu “luôn nhanh”, “luôn nhất quán” hay “mô hình tốt” thường trở thành sai.",
...
"tu_kiem_tra": [
  "Vẽ lại luồng của “Ô tìm kiếm gợi ý (typeahead)” và ghi state tại từng node.",
...
"lien_he": "“Ô tìm kiếm gợi ý (typeahead)” nối sang các mảng khác qua cùng ba câu hỏi: dữ liệu/state nằm đâu, contract nào phải giữ, và failure được quan sát/phục hồi thế nào. Khi hệ thống có model AI, quyết định ở bài này ảnh hưởng trực tiếp data quality, serving latency, privacy và khả năng tái lập."
};
