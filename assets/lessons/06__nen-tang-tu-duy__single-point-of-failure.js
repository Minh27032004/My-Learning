window.LESSONS["06:nen-tang-tu-duy:single-point-of-failure"] = {

"tom_tat": [
  "“Single point of failure” phải được hiểu như một cơ chế có input, state, output và failure mode; không phải định nghĩa để học thuộc.",
...
"tu_kiem_tra": [
  "Vẽ lại luồng của “Single point of failure” và ghi state tại từng node.",
...
"lien_he": "“Single point of failure” nối sang các mảng khác qua cùng ba câu hỏi: dữ liệu/state nằm đâu, contract nào phải giữ, và failure được quan sát/phục hồi thế nào. Khi hệ thống có model AI, quyết định ở bài này ảnh hưởng trực tiếp data quality, serving latency, privacy và khả năng tái lập."
};
