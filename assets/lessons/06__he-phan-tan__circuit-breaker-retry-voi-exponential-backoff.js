window.LESSONS["06:he-phan-tan:circuit-breaker-retry-voi-exponential-backoff"] = {

"tom_tat": [
  "“Circuit breaker, retry với exponential backoff” phải được hiểu như một cơ chế có input, state, output và failure mode; không phải định nghĩa để học thuộc.",
...
"dinh_nghia": "**Circuit breaker, retry với exponential backoff** thuộc System Design, module **Hệ phân tán**. Hãy định nghĩa nó bằng ba lớp: contract quan sát được từ bên ngoài; state/invariant phải giữ bên trong; và giả định môi trường để guarantee còn đúng. Nếu bỏ lớp giả định, câu “luôn nhanh”, “luôn nhất quán” hay “mô hình tốt” thường trở thành sai.",
...
"tu_kiem_tra": [
  "Vẽ lại luồng của “Circuit breaker, retry với exponential backoff” và ghi state tại từng node.",
